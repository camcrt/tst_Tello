...
val_twist_x = val_twist_y = val_twist_y = x_drone1 = y_drone1 = z_drone1 = x_drone2  = y_drone2 = z_drone2 = 0.0
...
def callback1(data):
    ...
    def regul_x():
        ...
        val_twist_x = -1 * pid.compute(data.pose.position.x, TIME_STEP)
        #rospy.loginfo("commande : %s" %str(val_twist_x))
    ...
    def regul_y():
        ...
        val_twist_y = -1 * pid.compute(data.pose.position.y, TIME_STEP)
    ...
    def regul_z():
        ...
        val_twist_z = pid.compute(data.pose.position.z, TIME_STEP)
    ...
    cmd.linear.x =val_twist_x
    cmd.linear.y =val_twist_y
    cmd.linear.z =val_twist_z
